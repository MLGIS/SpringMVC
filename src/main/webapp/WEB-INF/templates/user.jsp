...
<body ng-app="myApp" calss="ng-cloak">
	 <div class="generic-container" ng-controller="UserController as ctrl" ng-init="ctrl.fetchAllUsers()">
      ...
      <script src="/test/static/jsApi/angular15.js"></script>
      <script src="<c:url value='/static/main/app.js' />"></script>
      <script src="<c:url value='/static/service/user.js' />"></script>
      <script src="<c:url value='/static/control/user.js' />"></script>
